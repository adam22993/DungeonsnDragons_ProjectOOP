...
public class GameUI {
    ...
    public void openWelcomeScreen() {
        ...
        startButton.addActionListener(e -> {
            characterCreationScreen(controlLayer.characterChoice());
        });
        ...
        quitButton.addKeyListener(controlLayer.keyboardButtonListener);
    ...
    public void createGameScreen(Player playerUnit, String board) {
        ...
        // create player panel
        playerPanel = controlLayer.playerControls();
